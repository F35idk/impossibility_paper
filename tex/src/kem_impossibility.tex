...
inherent (\TODO{elaborate}), or if the result can be improved to \(\ell = \Omega(\rho)\).
...
\begin{namedproof}{Proof of Theorem \ref{thm:main}}
  ...
  By our definition of a KEM (\TODO{ref.}),
  ...
  and we defer the proof to Appendix \TODO{ref.}.
