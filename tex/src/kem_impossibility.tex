...
\begin{namedproof}{Proof of Theorem \ref{thm:main}}
  ...
  \begin{align}\label{ineq:insertthis1}
    \frac{1/\mu + \negl}{1/\mu + \alpha + \negl} \le \frac{1/\mu + \negl}{1/\mu + \negl} = 1 + \negl,
  \end{align}
  and using \(1/\mu + \alpha \le 2 \max \{1/\mu, \alpha\}\)
  ...
  \begin{align}
    ...
    % & \ge \mu - \mu^{2} 5 q / \rho - \negl, \notag
  \end{align}
  Recalling that \(\alpha \le 5q / \rho\) now yields
  ...
  hence runs the adversary \advA to completion, we get
  \[
    \ell \ge \frac{\epsilon_{\advA}}{\epsilon_{\redR^{\advA}}} \ge \frac{1}{2}(1 - 1 / \abs{\keyspace}) \min \left\{ \mu, \rho / (5q) \right\} - 1 - \negl, \notag
  \]
  as desired.
\end{namedproof}
