...
\begin{proof}[Proof of Theorem \ref{thm:owecpa}]
  ...
  \begin{enumerate}[itemsep=0.1cm]
    \item Receive the challenge \(c\) from the challenger in the game \SICA (recall Figure \TODO{ref.}).
  ...
  is given the same random coins at line \TODO{ref.} of Figure \TODO{ref.} in either instance of the \SICA game.
  ...
  by \(s_{\redM}\) and \(s_{\redR}\), respectively (corresponding to line \TODO{fix} of Figure \TODO{ref.})
