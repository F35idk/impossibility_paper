...
\TODO{Motivate the generalization.}

\begin{definition}[Trapdoor puzzles]
...
\TODO{consider finding a more suggestive name than ``trapdoor puzzles''.}

\begin{definition}[\((1-\delta)\)-correctness of a trapdoor puzzle]\label{def:corr}
