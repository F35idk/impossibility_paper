...
Theorem \ref{thm:etpa} follows the template of many previous tightness
impossibility results, e.g as in \TODO{cite}.
...
\TODO{this can probably be moved \emph{into} the proof?}
